...
import (
	...
	helper "github.com/kiruiaaron/GO-JWT-AUTHENTICATION-WITH-GIN-GONIC/helpers"
	"github.com/kiruiaaron/GO-JWT-AUTHENTICATION-WITH-GIN-GONIC/models"
...
func Login() gin.HandlerFunc{
	return func(c *gin.Context) {
		...
		passwordIsVald, msg := VerifyPassword(*user.Password, *foundUser.Password)
		defer cancel()
		if passwordIsVald != true{
			c.JSON(http.StatusInternalServerError, gin.H{"error":msg})
			return
		}
